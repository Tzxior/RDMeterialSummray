...
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QPushButton, QComboBox, QListView, QListWidget, QFileDialog, QLabel, QMessageBox, QLineEdit, QDialog, QHBoxLayout
...
class RDMaterialSummaryApp(QWidget):
    ...
    def initUI(self):
        ...
        self.importButton = QPushButton('记录', self)
        self.importButton.setGeometry(5, 452, 470, 22)
    ...
    def updateSampleNumberComboBox(self):
        ...
        if selected_value:
            ...
            self.sampleNumberComboBox.addItems(sample_numbers)
